...
# original_path = "result/BoolQ_syllogism_multi_T0.9_p0.7_2024-06-13 02:06:13.csv"
pathList = [
    # 'result/BoolQ_sccot_T0.9_p0.7_2024-06-11 02:07:36.json',
    'result/BoolQ_sc_cot_T0.9_p0.7_2024-01-20 14:58:28.json',
    # 'result/BoolQ_cot_yesorno_multi_T0.9_p0.7_2024-06-14 19:34:36.json',
]
            ...
            for i, data_point in enumerate(data_points):
                ...
                try:
                    if prediction == None:
                        ...
                        all_invalid += 1
                    elif prediction.find('Yes\'') != -1 or prediction.find('Yes.') != -1 or prediction.find('True') != -1 or prediction.find('Yes') == 0:
