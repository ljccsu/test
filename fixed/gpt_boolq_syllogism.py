...
pathDic = {
    'gpt_syllogism_v6': 'result/BoolQ_syllogism_dev_v6_T0.2_p0.3_2024-06-08 19:50:49.csv',
    'gpt_syllogism_v8': 'result/BoolQ_syllogism_dev_v8_T0.2_p0.3_2024-06-13 02:10:53.csv',
    'gpt_syllogism_v8_multi': 'result/BoolQ_syllogism_dev_v8_multi_T0.9_p0.7_2024-06-13 02:06:13.csv'
}
import requests
import json
import random
...
def is_data_point_invalid(data):
    required_fields = ["question", "passage", "explanation", "major", "minor_question", "minor", "prediction"]
    return any(data.get(field) in (None, '', 'None') for field in required_fields)

def main():
    original_path = 'result/BoolQ_syllogism_dev_v6_no_explanation_T0.2_p0.3_2024-08-11 20:53:54.csv'
    ...
    with open(original_path, 'r') as f, open(fixed_path, 'w') as fo:
        ...
        for i, data_point in enumerate(data_points):
            ...
            try:
                ...
                major = ''
            try:
                minor_question = data["minor_question"]
            except:
                minor_question = ''
            try:
                minor = data["minor"]
